...
export default function FiveMealsSuccess() {
  ...
  const translations = {
    en: {
      ...
      message: "Your 5 Meals for Winter card has been added to your Mama account.",
      ...
      specialNote: "Remember: Your 5th bowl comes with a free Ceremonial Cacao, tea or coffee ☕",
      viewAccount: "View My Account",
      backHome: "Back to Home",
    },
    is: {
      title: "Greiðsla tókst! 🎉",
      message: "5 Réttir fyrir Veturnn kortið þitt hefur verið bætt við Mama reikninginn þinn.",
      emailSent: "Staðfestingarpóstur hefur verið sendur á netfangið þitt.",
      howToUse: "Hvernig á að nota",
      instructions: [
        "Skráðu þig inn á Mama reikninginn þinn",
        "Heimsæktu veitingastaðinn á opnunartíma",
        "Sýndu símann með reikningnum þínum",
        "Njóttu sálvarmandi réttarins!",
      ],
      specialNote: "Mundu: 5. bollinn þinn kemur með ókeypis Athafnacacao, te eða kaffi ☕",
      viewAccount: "Skoða Reikninginn Minn",
        ...
        >
          ...
          <div className="px-8 py-12">
            ...
            <div className="bg-gradient-to-br from-orange-50/50 to-emerald-50/50 p-6 rounded-xl border border-orange-100/50 mb-8 text-left">
              <h2 className="text-xl font-light text-gray-900 mb-4 text-center tracking-tighter" style={{ letterSpacing: "-0.02em" }}>
                {t.howToUse}
              </h2>
