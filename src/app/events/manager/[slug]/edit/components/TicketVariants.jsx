              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <span className="text-sm" style={{ color: "#9a7a62" }}>kr</span>
                  </div>
                  <input
                    type="number"
                    value={variant.price}
                    ...
                    min="0"
                    className="w-full pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#ff914d]/30 focus:border-[#ff914d]/60 transition-all duration-200 bg-white text-sm"
                    style={{ border: "1px solid #e8ddd3", color: "#2c1810" }}
                  />
                </div>
              </div>
