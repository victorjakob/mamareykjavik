        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <Link
                href="/admin/cards"
                onClick={() => setNavigatingTo("/admin/cards")}
                className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out block"
              >
            ...
            >
              <Link
                href="/admin/bookings"
                onClick={() => setNavigatingTo("/admin/bookings")}
                className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out block"
              >
                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-gradient-to-br from-[#a77d3b] to-[#8b6a2f] opacity-10 group-hover:opacity-20 transition-opacity" />
                <div className="relative flex items-center">
                  <div className="flex-shrink-0">
                    {navigatingTo === "/admin/bookings" ? (
                      <Loader2 className="h-10 w-10 text-[#a77d3b] animate-spin" />
                    ) : (
                      <ClipboardList className="h-10 w-10 text-[#a77d3b]" />
                    )}
                  </div>
                  <div className="ml-6">
            ...
            >
              <Link
                ...
                onClick={() => setNavigatingTo("/admin/summer-market")}
                className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out block"
              >
                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-gradient-to-br from-orange-500 to-amber-600 opacity-10 group-hover:opacity-20 transition-opacity" />
                <div className="relative flex items-center">
                  <div className="flex-shrink-0">
                    {navigatingTo === "/admin/summer-market" ? (
                      <Loader2 className="h-10 w-10 text-amber-600 animate-spin" />
                    ) : (
                      <Flower2 className="h-10 w-10 text-amber-600" />
                    )}
                  </div>
                  <div className="ml-6">
                    <h2 className="text-2xl font-bold text-gray-900 group-hover:text-amber-600 transition-colors">
