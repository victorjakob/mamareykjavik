...
const CONTENT = {
  en: {
    ...
    details: [
      { k: "When", t: "Every morning", b: "9:00 – 11:30, every day. Then lunch & dinner until 21:30." },
    ...
    faq: {
      ...
      items: [
        { q: "What time is breakfast served?", a: "Every day from 9:00 to 11:30. We stay open until 21:30 for lunch and dinner after that." },
  ...
  is: {
    ...
    details: [
      { k: "Hvenær", t: "Alla morgna", b: "9:00–11:30 alla daga. Eftir það er opið fyrir hádegismat og kvöldmat til 21:30." },
    ...
    faq: {
      ...
      items: [
        { q: "Hvenær er morgunmatur borinn fram?", a: "Alla daga frá 9:00 til 11:30. Eftir það er opið áfram til 21:30 fyrir hádegismat og kvöldmat." },
