  ...
  try {
    ...
    if (
      ...
      const seriesRow = {
        ...
        community_link: eventDetails.community_link || null,
        community_link_label: eventDetails.community_link_label || null,
        community_link_public: !!eventDetails.community_link_public,
        community_link_in_email: !!eventDetails.community_link_in_email,
