// RenewalSucceeded — sent automatically when a Tribe renewal charge succeeds.
// Replaces the inline-HTML version in src/lib/membershipEmails.js.
...
export default function RenewalSucceeded({
  name = "there",
  amount = 2000,
  currency = "ISK",
  ...
  return (
    <BrandLayout
      preview={`Your Mama Tribe renewal — ${formatMoney(amount, currency)}`}
      eyebrow="Mama · Tribe"
    >
      <BrandHeading size="lg">Your renewal went through.</BrandHeading>

      <BrandText>Hi {firstName},</BrandText>
      <BrandText>
        Thank you for continuing to be part of Mama Tribe — your support
        keeps this little community cooking.
      </BrandText>
      ...
      <BrandText tone="muted" style={{ marginTop: "20px", fontSize: "13.5px" }}>
        You can manage your subscription or update your card anytime from
        your member page.
      </BrandText>
...
RenewalSucceeded.subject = "Your Mama Tribe renewal · 2.000 kr.";
