...
export const EMAIL_MANIFEST = [
  ...
  {
    id: "tribe-card-expiring-soon",
    name: "Tribe Card Expiring Soon",
    group: "account",
    trigger: "Daily cron — 30 days before a gifted / legacy Tribe Card's expires_at (once per card)",
    recipient: "Cardholder",
    status: "templated",
    templateImport: "TribeCardExpiringSoon",
  },
  {
    id: "tribe-card-expired",
    name: "Tribe Card Expired",
    group: "account",
    trigger: "Daily cron — the day a gifted / legacy Tribe Card flips to expired (once per card)",
    recipient: "Cardholder",
    status: "templated",
    templateImport: "TribeCardExpired",
  },
  {
    id: "tribe-card-expired-followup",
    name: "Tribe Card Follow-up",
    group: "account",
    trigger: "Daily cron — 14 days after a Tribe Card expired, if still no paid membership (once per card)",
    recipient: "Cardholder",
    status: "templated",
    templateImport: "TribeCardExpiredFollowUp",
  },
  {
    id: "tribe-card-invite",
    name: "Tribe Invite (unlimited cards)",
    group: "account",
    trigger: "Admin-triggered one-off — invites unlimited-card holders to the paid Tribe (once per card)",
    recipient: "Cardholder",
    status: "templated",
    templateImport: "TribeCardInvite",
  },
  {
  ...
  {
    id: "summer-market-weekend-welcome",
    name: "Summer Market Weekend Welcome",
    group: "marketing",
    trigger: "Admin triggers the per-weekend welcome batch a few days before market days",
    recipient: "Confirmed weekend vendors",
    status: "templated",
    templateImport: "SummerMarketWeekendWelcome",
    note: "Sent via /api/admin/summer-market/send-weekend-welcome. Idempotent via weekend_welcome_sent_at.",
  },
  {
    id: "summer-market-schedule-change",
    name: "Summer Market Schedule Change",
    group: "operations",
    trigger: "Admin triggers a change-of-plan notice for a specific market day",
    recipient: "Vendors booked on the affected date",
    status: "templated",
    templateImport: "SummerMarketScheduleChange",
    note: "Sent via /api/admin/summer-market/send-schedule-change. Each call sends a fresh email; not deduplicated since changes can happen more than once for the same day.",
  },
  {
