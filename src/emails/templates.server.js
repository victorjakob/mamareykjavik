...
export const TEMPLATE_LOADERS = {
  ...
  "tribe-card-expiring-soon":         () => import("./templates/TribeCardExpiringSoon"),
  "tribe-card-expired":               () => import("./templates/TribeCardExpired"),
  "tribe-card-expired-followup":      () => import("./templates/TribeCardExpiredFollowUp"),
  "tribe-card-invite":                () => import("./templates/TribeCardInvite"),
